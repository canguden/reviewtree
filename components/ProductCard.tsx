    ...
    <div>
      <div className="relative mx-2">
        ...
        <div className="relative mt-4">
          ...
          <p className="mt-2">{getProductDescription(price.product)}</p>
        </div>
      ...
      <div className="mt-6">
        <button
          ...
          className="relative w-full flex bg-green-500 hover:bg-green-500 border border-transparent rounded-md py-2 px-8 items-center justify-center text-sm font-medium text-white"
        >
          Add to bag
